...
\titleformat{\chapter}[display]
    ...
    {Chapter \thechapter}{0pt}{\setlength{\parskip}{0em}\LARGE}
...
% 设置标题上下间距
% 参数分别为：左缩进、段前间距、段后间距
\titlespacing*{\chapter}{0pt}{0em}{10em}
\titlespacing*{\section}{0pt}{1em}{0.5em} % section 标题与正文的距离
\titlespacing*{\subsection}{0pt}{1em}{0.5em} % subsection 标题与正文的距离
\titlespacing*{\subsubsection}{0pt}{1em}{0.5em} % subsubsection 标题与正文的距离
